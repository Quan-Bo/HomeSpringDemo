   ...
   <div class="login">
	<div class="loginmain">
		<h2> <label class="col-lg-1 control-label"></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;登录管理系统</h2>
			<form action="UserManager" class="form-horizontal" method="post">
		           <!-- 让表单在一行中显示form-horizontal -->
		             <div class="form-group"></div>
		          <div class="form-group">
		              <label for="username" class="col-lg-1 control-label"></label>
		              <div class="col-lg-4">
		                <input type="text" name="username" id="username" onfocus="ClealText()" class="form-control"  value="<%=username%>"  placeholder="用户名/邮箱/手机号">
		              </div>              
		          </div>
		          ...
		          <div class="form-group">
		              ...
		              <div class="col-lg-4">
		                <input type="password" name="password" id="password" class="form-control" onfocus="ClealText()" placeholder="密码">
		              </div>              
		          </div>
		           <div class="form-group"></div>
                   <div class="form-group"></div>
